...
determine the automorphism group and to test isomorphism of such algebras 
...
Moreover, the package can compute various group-theoretical properties of groups
...
manual for more information. Then simply unpack `modisom-X.Y.Z.tar.gz` and
...
The manual of ModIsom is in the `doc` directory, as `doc/manual.pdf` or
`doc/chap0_mj.html`.
